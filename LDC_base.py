# Base model, LDC level, iterative F-tests
import pandas as pd
import os
...
results_df.to_csv('/Users/renaudchailloux/Desktop/Output Data/Base Model//LDC_base_regression_results.csv')
print("Regression results saved to 'LDC_base_regression_results.csv'")
...
def save_fixed_effects(results):
    ...
    fe_unstacked.to_csv('/Users/renaudchailloux/Desktop/Output Data/Base Model/LDC_base_unstacked_fixed_effects.csv')
    print("Unstacked fixed effects saved to 'LDC_base_unstacked_fixed_effects.csv'")
